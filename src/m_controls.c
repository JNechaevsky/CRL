...
void M_BindMenuControls(void)
{
    ...
    M_BindIntVariable("key_crl_vilefly",      &key_crl_vilefly);
    ...
    M_BindIntVariable("key_crl_extendedhud", &key_crl_extendedhud);
